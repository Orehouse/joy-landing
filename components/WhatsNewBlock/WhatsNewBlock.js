...
function WhatsNewBlock() {
  return <BlockTemplate>
    <div className={styles.whatsNewBlock}>
      ...
      <h5 className={styles.letsStart}>Начнем по порядку</h5>
      ...
      <WhatsNewBlockFeature title={'Сайт'}>
        ...
        <div className={styles.site}>
          <div>
            <div className={styles.tanyaImg}>
              <Image src={tanya} alt="Таня"/>
            </div>
            <div className={styles.tanyaSign}>Дизайн полностью переработала
              Таня, UX-дизайнер и соосновательница платформы.
            </div>
          </div>
          <div className={styles.quote}>«Сайт и личный кабинет теперь
